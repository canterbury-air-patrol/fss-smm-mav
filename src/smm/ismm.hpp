...
class ISMM
{
  public:
     ...
     * (EventDispatcher, todo/76), not by FMUStateMachine (which only needs
     * the two methods above). Part of this interface so both can be driven
     * by the same mock in tests. */
