...
/* The autopilot restarted underneath us while the link stayed up. Carries
 * nothing: the only thing the event loop does with it is re-apply the state
 * machine's current state, which it already holds. */
