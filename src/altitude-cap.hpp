 ...
 * latch, factored out of FMUStateMachine::setCurrentAltitude so the
 * safety-critical over-cap comparison is unit-testable without constructing
 * a state machine. Mirrors smm/search-altitude.hpp's style. */
 ...
 * getAltitudeMetres() carries. Strict '>', not '>=': a
